      ...
      <div class="row">
         <div class="col-lg-6 wow fadeIn" fadeIndata-wow-duration=".1s" data-wow-delay=".1s">
            <div class="about-creative-images">
               ...
               <div class="image-two">
                  <img src="<?php echo base_url(''); ?>/images/about/about.jpg" alt="AboutImage">
               </div>
            </div>
         </div>
            ...
            <div class="about-creative-details">
               ...
               <div class="accordion about-accordion" id="faqone">
                  ...
                  <div class="accordion-item faq-accordion-item">
                     ...
                     <div id="headingFour" class="accordion-collapse collapse faq-accordion-collapse" aria-labelledby="headingThree" data-bs-parent="#faqone">
                        <p class="accordion-body">
